...
export default function TabsHome() {
  ...
  const getHaikus = () => {
    fetch("https://secret-lake-66228.herokuapp.com/haikus")
      .then((response) => {
  ...
  const getHaikusByVote = () => {
    fetch("https://secret-lake-66228.herokuapp.com/haikus/top")
      .then((response) => {
        return response.json();
      })
      .then((result) => {
  ...
  const favoriteFunc = (fav) => {
    ...
    fetch(`https://secret-lake-66228.herokuapp.com/haikus/${fav._id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
